...
public class FeatureContingencyConstants{
	...
	public static final int FCID_SHAKESHOP = 2;
	...
	public static final int FCID_CHECKIN_PIC = 14;
	
	public static final int FCID_MEMBERCARD = 15; 
	
	public static final int FCID_FAVORITE = 16; 
	
	public static final int FCID_SIGNUP = 17; 
	
	public static final int FCID_THIRD_FEED_LOG = 18;
	
	public static final int FCID_DPSFLIMIT = 19;
	
	public static final int FCID_FRIEND_SERVICE = 20;
	
	public static final int FCID_USER_SERVICE = 21;
	
	public static final int FCID_SHOP_SERVICE = 22;
}
